...
**Stage 4 status:** smoke + operational deep + **digest-surface PASS**
(2026-08-13, budget-limited) — `STAGE4_SMOKE_R2.md`, `STAGE4_DEEP_R2.md`,
`STAGE4_DIGEST_R2.md`; larger optional stress and public challenge still open.
